...
const projects = [
      { title: 'GAP – API Intelligence Platform',
        date: 'Mei 2026',
        desc: 'Platform kecerdasan API berbasis TypeScript yang secara otomatis mendeteksi rute, request body, dan ketidaksesuaian kontrak backend-frontend langsung dari source code menggunakan RAG dan Regular Expressions, tanpa anotasi manual.',
        tech: ['TypeScript', 'Node.js', 'RAG', 'LangChain'],
        images: ['/projects/gap-1.png'],
        github: '',
        demo: '' },
      { title: 'Proposal & LPJ Generator for DITMAWA',
        date: 'April 2026',
        desc: 'Alat internal untuk Direktorat Kemahasiswaan Telkom University yang memungkinkan 50+ organisasi mahasiswa menghasilkan dokumen Proposal Kegiatan dan LPJ secara otomatis, menggantikan alur manual yang sebelumnya membutuhkan 2+ jam per dokumen.',
        tech: ['PHP', 'Laravel', 'MySQL', 'dompdf'],
        images: ['/projects/ditmawa-1.png'],
        github: '',
        demo: '' },
      { title: 'Vendor Marketplace',
        date: 'On-Going',
        desc: 'Platform social commerce berbasis posting, dirancang sebagai marketplace satu atap untuk ekosistem kampus yang menargetkan pengguna Gen Z. Dilengkapi verifikasi vendor multi-kategori dan mekanisme cross-sponsorship antar UKM dan organisasi mahasiswa.',
        tech: ['Node.js','NestJS','Prisma','TypeScript','PostgreSQL'],
        images: ['/projects/vendor-1.jpg'],
        github: 'https://github.com/mxslr/vendor-marketplace.git',
        demo: '' },
      { title: 'AMANIN',
        date: 'On-Going',
        desc: 'Aplikasi Pendeteksi Gambar dan Video hasil AI Generatif untuk mencegah penipuan berbasis media dengan memanfaatkan model deteksi deepfake dan teknik forensik digital.',
        tech: ['Next.js', 'Tailwind CSS', 'FastAPI', 'Python', 'SQLAlchemy', 'PostgreSQL', 'Supabase', 'PyTorch', 'OpenCV'],
        images: ['/projects/amanin-1.png', '/projects/amanin-2.png', '/projects/amanin-3.png', '/projects/amanin-4.png'],
        github: 'https://github.com/mxslr/amanin-frontend.git',
        demo: 'https://amanin-project.vercel.app/' },
      { title: 'KantinKu Dashboard',
        date: 'Januari 2026',
        desc: 'Dashboard interaktif untuk mengimplementasikan arsitektur microservices untuk memantau dan mengelola operasional kantin secara real-time.',
        tech: ['Vanilla JS', 'Node.js', 'Express.js', 'GraphQL', 'Docker'],
        images: ['/projects/kantinku-1.jpeg', '/projects/kantinku-2.jpeg', '/projects/kantinku-3.jpeg', '/projects/kantinku-4.jpeg'],
        github: 'https://github.com/mxslr/kantinku.git',
        demo: '' },
      { title: 'Warkop Maju Jaya',
        date: 'Desember 2025',
        desc: 'Sistem backend solid untuk digitalisasi pencatatan dan operasional warung kopi modern yang efisien.',
        tech: ['Node.js', 'Express', 'Vanilla JS', 'HTML/CSS', 'Docker'],
        images: ['/projects/warkop-1.jpeg', '/projects/warkop-2.jpeg', '/projects/warkop-3.jpeg'],
        github: 'https://github.com/mxslr/warkop-maju-jaya.git',
        demo: '' },
      { title: 'Sistem Booking Ruangan',
        date: 'Mei 2025',
        desc: 'Sistem Informasi Booking Ruangan berbasis web yang memungkinkan mahasiswa dan dosen untuk mengajukan booking ruangan secara online 24/7.',
        tech: ['Laravel', 'PHP', 'MySQL', 'Bootstrap', 'JavaScript'],
        images: ['/projects/booking-1.png', '/projects/booking-2.png', '/projects/booking-3.png', '/projects/booking-4.png'],
        github: 'https://github.com/mxslr/booking-ruangan-telkomuniversity.git',
        demo: '' },
      { title: 'ConcertHub',
        date: 'Desember 2025',
        desc: 'Sistem Pemesanan Tiket Konser Berbasis Web yang memungkinkan pengguna untuk mencari, memilih, dan membeli tiket konser secara online.',
        tech: ['Node.js', 'Express.js', 'GraphQL', 'Docker', 'Vanilla JS'],
        images: ['/projects/concerthub-1.png', '/projects/concerthub-2.png', '/projects/concerthub-3.png', '/projects/concerthub-4.png', '/projects/concerthub-5.png', '/projects/concerthub-6.png', '/projects/concerthub-7.png '],
        github: 'https://github.com/mxslr/concerthub-microservices.git',
        demo: '' },
    ];

const experiences = [
  { role: 'Artificial Intelligence Engineer',
    org: 'HUMIC Engineering Research Center (Internship)',
    date: 'April 2026 - Present',
    desc: 'Selected as 1 of 4 division members for the Computer Vision track at HUMIC Research Center. Conducting Systematic Literature Review across IEEE, Scopus, and Google Scholar, designing and training deep learning models for mammography image classification using 7,000+ medical images (INbreast, MIAS, DDSM datasets), and building end-to-end experiment pipelines with Python, PyTorch, TensorFlow, and OpenCV across 9 sprint cycles.' },
  { role: 'Full-Stack Developer',
    org: 'Central Computer Improvement (CCI) Telkom University',
    date: 'Februari 2026 - Present',
    desc: 'Anggota divisi R&D, berkontribusi pada 2 proyek paralel. Membangun sistem backend Vendor Marketplace menggunakan NestJS, PostgreSQL, dan Prisma ORM. Secara mandiri mengembangkan Proposal & LPJ Generator untuk Ditmawa dalam sprint 3 hari, menggantikan alur manual yang sebelumnya membutuhkan 2+ jam per dokumen untuk 50+ organisasi mahasiswa.' },
  { role: 'Staff of Competition Division',
    org: 'ERP Laboratory Telkom University',
    date: 'Maret 2026 - Present',
    desc: 'Menjadi Penanggung Jawab program kerja \'Champions Teams\' yang berfokus pada pengembangan iklim kompetitif mahasiswa. Memimpin brainstorming mingguan, mengelola grup komunitas, dan mengkurasi 10+ informasi perlombaan setiap bulan melalui media sosial laboratorium, menjangkau 1.000+ pengikut.' },
  { role: 'Sponsorship of Competition Squad',
    org: 'TUNFC 2026 (Telkom Univ. National Futsal Championship)',
    date: 'Desember 2025 - Present',
    desc: 'Bertugas dalam Divisi Sponsorship untuk TUNFC 2026, acara futsal nasional dengan 35+ tim dari universitas seluruh Indonesia. Mengidentifikasi dan mendekati 40+ sponsor korporat potensial, melakukan 15+ sesi pitching, dan berkontribusi pada tingkat pemenuhan slot sponsorship 100% sebelum hari pertandingan.' },
];
...
const translations = {
  en: {
    ...
    projects: [
      { title: 'GAP – API Intelligence Platform',
        date: 'May 2026',
        desc: 'An API intelligence platform built with TypeScript that auto-detects routes, request bodies, and backend-to-frontend contract mismatches directly from source code, leveraging RAG and Regular Expressions with zero annotations required.',
        tech: ['TypeScript', 'Node.js', 'RAG', 'LangChain'],
        images: ['/projects/gap-1.png', '/projects/gap-2.png', '/projects/gap-3.png', '/projects/gap-4.png', '/projects/gap-5.png', '/projects/gap-6.png', '/projects/gap-7.png'],
        github: '',
        demo: '' },
      { title: 'Proposal & LPJ Generator for DITMAWA',
        date: 'April 2026',
        desc: 'An internal tool for Telkom University\'s student directorate enabling 50+ student organizations to generate official Proposal Kegiatan and LPJ documents automatically, replacing a manual workflow that previously took 2+ hours per document.',
        tech: ['PHP', 'Laravel', 'MySQL', 'dompdf'],
        images: ['/projects/ditmawa-1.png', '/projects/ditmawa-2.png', '/projects/ditmawa-3.png', '/projects/ditmawa-4.png', '/projects/ditmawa-5.png', '/projects/ditmawa-6.png'],
        github: '',
        demo: '' },
      { title: 'Vendor Marketplace',
        date: 'On-Going',
        desc: 'A social commerce platform built around posts, designed as a one-stop marketplace for the campus ecosystem targeting Gen Z users. Features multi-category vendor verification and a cross-sponsorship mechanism allowing SMEs and student organizations to sponsor each other.',
        tech: ['Node.js','NestJS','Prisma','TypeScript','PostgreSQL'],
        images: ['/projects/vendor-1.jpg'],
        github: 'https://github.com/mxslr/vendor-marketplace.git',
        demo: '' },
      { title: 'AMANIN',
        date: 'On-Going',
        desc: 'An AI-powered image and video detection app designed to prevent media-based fraud by leveraging deepfake detection models and digital forensic techniques.',
        tech: ['Next.js', 'Tailwind CSS', 'FastAPI', 'Python', 'SQLAlchemy', 'PostgreSQL', 'Supabase', 'PyTorch', 'OpenCV'],
        images: ['/projects/amanin-1.png', '/projects/amanin-2.png', '/projects/amanin-3.png', '/projects/amanin-4.png'],
        github: 'https://github.com/mxslr/amanin-frontend.git',
        demo: 'https://amanin-project.vercel.app/' },
      { title: 'KantinKu Dashboard',
        date: 'January 2026',
        desc: 'An interactive dashboard to implement a microservices architecture for monitoring and managing cafeteria operations in real time.',
        tech: ['Vanilla JS', 'Node.js', 'Express.js', 'GraphQL', 'Docker'],
        images: ['/projects/kantinku-1.jpeg', '/projects/kantinku-2.jpeg', '/projects/kantinku-3.jpeg', '/projects/kantinku-4.jpeg'],
        github: 'https://github.com/mxslr/kantinku.git',
        demo: '' },
      { title: 'Warkop Maju Jaya',
        date: 'December 2025',
        desc: 'A solid backend system for efficient digitization of record-keeping and operations for modern coffee shops.',
        tech: ['Node.js', 'Express', 'Vanilla JS', 'HTML/CSS', 'Docker'],
        images: ['/projects/warkop-1.jpeg', '/projects/warkop-2.jpeg', '/projects/warkop-3.jpeg'],
        github: 'https://github.com/mxslr/warkop-maju-jaya.git',
        demo: '' },
      { title: 'Sistem Booking Ruangan',
        date: 'May 2025',
        desc: 'A web-based Room Booking Information System that allows students and lecturers to submit room bookings online 24/7.',
        tech: ['Laravel', 'PHP', 'MySQL', 'Bootstrap', 'JavaScript'],
        images: ['/projects/booking-1.png', '/projects/booking-2.png', '/projects/booking-3.png', '/projects/booking-4.png'],
        github: 'https://github.com/mxslr/booking-ruangan-telkomuniversity.git',
        demo: '' },
      { title: 'ConcertHub',
        date: 'December 2025',
        desc: 'A web-based Concert Ticketing System that allows users to browse, select, and purchase concert tickets online.',
        tech: ['Node.js', 'Express.js', 'GraphQL', 'Docker', 'Vanilla JS'],
        images: ['/projects/concerthub-1.png', '/projects/concerthub-2.png', '/projects/concerthub-3.png', '/projects/concerthub-4.png', '/projects/concerthub-5.png', '/projects/concerthub-6.png', '/projects/concerthub-7.png '],
        github: 'https://github.com/mxslr/concerthub-microservices.git',
        demo: '' },
    ...
    experiences: [
      { role: 'Artificial Intelligence Engineer',
        org: 'HUMIC Engineering Research Center (Internship)',
        date: 'April 2026 - Present',
        desc: 'Selected as 1 of 4 division members for the Computer Vision track. Conducting Systematic Literature Review across IEEE, Scopus, and Google Scholar, designing and training deep learning models for mammography image classification using 7,000+ medical images (INbreast, MIAS, DDSM datasets), and building end-to-end experiment pipelines with Python, PyTorch, TensorFlow, and OpenCV across 9 sprint cycles.' },
      { role: 'Full-Stack Developer',
        org: 'Central Computer Improvement (CCI) Telkom University',
        date: 'February 2026 - Present',
        desc: 'Member of the R&D division, contributing across 2 concurrent projects. Built backend systems for the Vendor Marketplace using NestJS, PostgreSQL, and Prisma ORM. Independently developed the Proposal & LPJ Generator for Ditmawa in a 3-day sprint, replacing a manual workflow that previously took 2+ hours per document across 50+ student organizations.' },
      { role: 'Staff of Competition Division',
        org: 'ERP Laboratory Telkom University',
        date: 'March 2026 - Present',
        desc: 'Responsible for the Champions Teams work program, developing a competitive environment for students. Leads weekly brainstorming sessions, manages community groups, and curates 10+ competition opportunities monthly across national and international categories, reaching 1,000+ students through the laboratory\'s social media channels.' },
      { role: 'Sponsorship of Competition Squad',
        org: 'TUNFC 2026 (Telkom Univ. National Futsal Championship)',
        date: 'December 2025 - Present',
        desc: 'Part of the Sponsorship Division for TUNFC 2026, a national futsal event hosting 35+ university teams. Approached 40+ potential corporate sponsors through targeted B2B outreach, conducted 15+ pitching sessions, and contributed to a 100% sponsorship slot fulfilment rate ahead of competition day.' },
    ],
    terminalLines: [
  ...
  id: {
    ...
    projects: [
      { title: 'GAP – API Intelligence Platform',
        date: 'Mei 2026',
        desc: 'Platform kecerdasan API berbasis TypeScript yang secara otomatis mendeteksi rute, request body, dan ketidaksesuaian kontrak backend-frontend langsung dari source code menggunakan RAG dan Regular Expressions, tanpa anotasi atau dokumentasi manual.',
        tech: ['TypeScript', 'Node.js', 'RAG', 'LangChain'],
        images: ['/projects/gap-1.png'],
        github: '',
        demo: '' },
    ...
    experiences: [
      { role: 'Insinyur Kecerdasan Buatan',
        org: 'HUMIC Engineering Research Center (Magang)',
        date: 'April 2026 - Sekarang',
        desc: 'Terpilih sebagai 1 dari 4 anggota divisi Computer Vision. Melakukan Systematic Literature Review di IEEE, Scopus, dan Google Scholar, merancang dan melatih model deep learning untuk klasifikasi citra mammografi menggunakan 7.000+ gambar medis (dataset INbreast, MIAS, DDSM), serta membangun pipeline eksperimen end-to-end dengan Python, PyTorch, TensorFlow, dan OpenCV dalam 9 sprint cycle.' },
      { role: 'Full-Stack Developer',
        org: 'Central Computer Improvement (CCI) Telkom University',
        date: 'Februari 2026 - Sekarang',
        desc: 'Anggota divisi R&D, berkontribusi pada 2 proyek paralel. Membangun sistem backend Vendor Marketplace menggunakan NestJS, PostgreSQL, dan Prisma ORM. Secara mandiri mengembangkan Proposal & LPJ Generator untuk Ditmawa dalam sprint 3 hari, menggantikan alur manual yang sebelumnya membutuhkan 2+ jam per dokumen untuk 50+ organisasi mahasiswa.' },
      { role: 'Staf Divisi Kompetisi',
        org: 'Laboratorium ERP Universitas Telkom',
        date: 'Maret 2026 - Sekarang',
        desc: 'Menjadi Penanggung Jawab program kerja Champions Teams yang berfokus pada pengembangan iklim kompetitif mahasiswa. Memimpin brainstorming mingguan, mengelola grup komunitas, dan mengkurasi 10+ informasi perlombaan setiap bulan melalui media sosial laboratorium, menjangkau 1.000+ pengikut.' },
      { role: 'Divisi Sponsorship Squad Kompetisi',
        org: 'TUNFC 2026 (Telkom Univ. National Futsal Championship)',
        date: 'Desember 2025 - Sekarang',
        desc: 'Bagian dari Divisi Sponsorship untuk TUNFC 2026, acara futsal nasional dengan 35+ tim dari universitas seluruh Indonesia. Mendekati 40+ sponsor korporat potensial melalui outreach B2B, melakukan 15+ sesi pitching, dan berkontribusi pada tingkat pemenuhan slot sponsorship 100% sebelum hari pertandingan.' },
    ],
    terminalLines: [
      { text: '> node server.js', muted: false },
