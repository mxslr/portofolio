...
const projects = [
      { title: 'Vendor Marketplace', 
        date: 'On-Going', 
        desc: 'Aplikasi marketplace komprehensif dirancang dengan modul untuk manajemen merchant, pemrosesan pesanan, dan sistem verifikasi aman.', 
...
const translations = {
  en: {
    ...
    projects: [
      { title: 'Vendor Marketplace', 
        date: 'On-Going', 
        desc: 'A comprehensive marketplace application designed with modules for merchant management, order processing, and secure verification systems.', 
        tech: ['Node.js','NestJS','Prisma','TypeScript','PostgreSQL'], 
        images: ['/projects/vendor-1.jpg'], 
        github: 'https://github.com/mxslr/vendor-marketplace.git', 
        demo: '' },
    ...
    experiences: [
      ...
      { role: 'Sponsorship Staff', 
        ...
        desc: 'Responsible for the sponsorship division, developing partnership offer strategies, and seeking potential partners to support the success of the national futsal championship.' },
      { role: 'Research & Development Division', 
        org: 'Central Computer Improvement (CCI)', 
        date: 'January 2026 - Present', 
        desc: 'Active in the R&D and Data Research division. Tasked with exploring new technologies, analyzing data, and contributing to technology innovation development.' },
    ],
    terminalLines: [
  ...
  id: {
    ...
    experiences: [
      ...
      { role: 'Divisi Penelitian dan Pengembangan', 
        ...
        desc: 'Aktif dalam divisi R&D dan Rekayasa Kecerdasan Buatan. Bertugas mengeksplorasi teknologi baru, menganalisis data, dan berkontribusi dalam pengembangan inovasi teknologi.' },
    ],
    terminalLines: [
      { text: '> node server.js', muted: false },
